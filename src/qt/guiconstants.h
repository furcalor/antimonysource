...
/* antimony GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "antimony"
#define QAPP_ORG_DOMAIN "antimonyproject.org"
#define QAPP_APP_NAME_DEFAULT "antimony-Qt"
#define QAPP_APP_NAME_TESTNET "antimony-Qt-testnet"
