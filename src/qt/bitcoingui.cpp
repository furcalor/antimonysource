                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Antimony Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    webmainAction = new QAction(QIcon(":/icons/explorer"), tr("&antimony Project"), this);
    webmainAction->setStatusTip(tr("antimony Project Website"));
    ...
    facebookAction->setStatusTip(tr("antimony Facebook"));
    ...
    twitterAction->setStatusTip(tr("antimony Twitter"));
    ...
    discordAction->setStatusTip(tr("antimony Discord"));
    ...
    youtubeAction->setStatusTip(tr("antimony Youtube"));
    ...
    telegramAction->setStatusTip(tr("antimony Telegram"));
    ...
    redditAction->setStatusTip(tr("antimony Reddit"));
    ...
    cmcAction->setStatusTip(tr("CoinMarketCap antimony"));
    ...
    exchangesAction->setStatusTip(tr("Markets to buy and sell antimony Coin (antimony)"));
    exchangesAction->setToolTip(exchangesAction->statusTip());
    exchangesAction->setCheckable(true);
    antimonyBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&antimony block explorer"), this);
    antimonyBlockExplorerAction->setStatusTip(tr("antimony blockchain explorer"));
    antimonyBlockExplorerAction->setToolTip(antimonyBlockExplorerAction->statusTip());
    antimonyBlockExplorerAction->setCheckable(true);
    githubAction = new QAction(QIcon(":/icons/github"), tr("&antimony Project Github"), this);
    githubAction->setStatusTip(tr("antimony Project Github"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a antimony address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and antimony: URIs)"));
...
//    }
    ...
    connect(antimonyBlockExplorerAction, SIGNAL(triggered()), this, SLOT(antimonyBlockExplorerActionClicked()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About antimony Core"), this);
    aboutAction->setStatusTip(tr("Show information about antimony Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for antimony"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your antimony addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified antimony addresses"));
    ...
    openAction->setStatusTip(tr("Open a antimony: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the antimony Core help message to get a list with possible antimony command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(aboutQtAction);
	  ...
	  QMenu* Links = appMenuBar->addMenu(tr("&Links"));
		...
		Links->addAction(antimonyBlockExplorerAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("antimony Core client") + " " + networkStyle->getTitleAddText();
...
{
	QDesktopServices::openUrl(QUrl("https://www.antimony.net"));
}
void BitcoinGUI::facebookActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://www.facebook.com/antimony.coin"));
}
void BitcoinGUI::twitterActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://twitter.com/antimony4"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://t.me/antimonycryptocurrency"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://www.reddit.com/user/antimony-coin"));
}
void BitcoinGUI::exchangesActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://"));
}
void BitcoinGUI::antimonyBlockExplorerActionClicked()
{
...
{
	QDesktopServices::openUrl(QUrl("https://github.com/antimony/antimony/"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to antimony network", "", count));
}
...
{
    QString strTitle = tr("antimony Core"); // default title
