...
QString BitcoinUnits::id(int unit)
{
    ...
    case antimony:
        return QString("ANTM");
    case mECA:
        return QString("mANTM");
    case uECA:
        return QString::fromUtf8("uantimony");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case antimony:
            return QString("ANTM");
        case mECA:
            return QString("Milli-antimony (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-antimony (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
