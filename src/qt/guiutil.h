...
/** Utility functions used by the antimony Qt UI.
 */
namespace GUIUtil
{
...
// Render antimony addresses in monospace font
...
// Parse "antimony:" URI into recipient object, return true on successful parsing
