...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("antimony Core"),
     ...
     * override -datadir in the antimony.conf file in the default data directory
     * (to be consistent with antimonyd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
