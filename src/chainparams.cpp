...
public:
    CMainParams()
    {
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "antimony is born";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1618267277;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 3040553;
        ...
        assert(genesis.hashMerkleRoot == uint256("0x1e880d926c6b7b73535c368f3ebb8fa78ca2ba6311d80007344142331f388692"));
        assert(hashGenesisBlock == uint256("0x00000e7065fd517b618623d4611ee200240db9bfb5e4b2aa5646645009adb1a1"));

     
		
	vSeeds.push_back(CDNSSeedData("142.4.214.15", "142.4.214.15"));
...
public:
    CTestNetParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0x1e880d926c6b7b73535c368f3ebb8fa78ca2ba6311d80007344142331f388692"));
        assert(hashGenesisBlock == uint256("0x0000e7356a38e01d66565cbc0245f8d3893d1c227b111d0afdc20994b21a3235"));
...
public:
    CRegTestParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0x1e880d926c6b7b73535c368f3ebb8fa78ca2ba6311d80007344142331f388692"));
        assert(hashGenesisBlock == uint256("0x2c3c1b655bbaf549f4819d8a587aaf3a8c84c719d0cc20b8ab666a91c6e6162c"));
